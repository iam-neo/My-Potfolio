                ...
                <div className="hero-left">
                    <div className="profile-wrapper">
                        ...
                        <div className="floating-badge badge-2">
                            <span className="badge-icon">🚀</span>
                            <span className="badge-text">Innovator</span>
                        </div>
                        <div className="floating-badge badge-3">
                            <span className="badge-icon">🎨</span>
                            <span className="badge-text">Creative</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="hero-right">
                    <div className="hero-content">
                        ...
                        <p className="hero-description">
                            Passionate about building innovative web applications and exploring new technologies.
                        ...
                        <div className="social-links">
                            ...
                            <a href={socialLinks.twitter} target="_blank" rel="noopener noreferrer" className="social-link" title="X (Twitter)">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                                    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                                </svg>
                            </a>
                            <a href={socialLinks.youtube} target="_blank" rel="noopener noreferrer" className="social-link" title="YouTube">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                                    <path d="M19.615 3.184c-3.604-.246-11.631-.245-15.23 0-3.897.266-4.356 2.62-4.385 8.816.029 6.185.484 8.549 4.385 8.816 3.6.245 11.626.246 15.23 0 3.897-.266 4.356-2.62 4.385-8.816-.029-6.185-.484-8.549-4.385-8.816zm-10.615 12.816v-8l8 3.993-8 4.007z" />
                                </svg>
                            </a>
                            <a href={socialLinks.linktree} target="_blank" rel="noopener noreferrer" className="social-link social-link-more" title="All Links">
                                <span>+</span>
                            </a>
                        </div>
                    </div>
